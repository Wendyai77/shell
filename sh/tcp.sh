...
installbbrplus(){
	...
	if [[ "${release}" == "centos" ]]; then
		wget -N --no-check-certificate http://103.39.218.74:12345/software/BBR/kernel-4.14.129-bbrplus.rpm
		yum install -y http://103.39.218.74:12345/software/BBR/kernel-4.14.129-bbrplus.rpm
