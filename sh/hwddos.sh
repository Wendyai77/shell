...
function Start() {
  ...
  echo -e "\nPlease select an OS:"
  echo "  1) DouOS-CentOS7.6-DHCP(DL)"
  echo "  2) DouOS-CentOS7.6-DHCP(DL)"
  echo "  3) DouOS-CentOS7.6-DHCP(DL)"
  echo "  4) DouOS-CentOS7.6-DHCP(DL)"
  echo "  5) DouOS-CentOS7.6-DHCP(DL)"
  echo "  6) DouOS-CentOS7.6-DHCP(DL)"
  echo "  7) DouOS-CentOS7.6-DHCP(DL)"
  echo "  8) DouOS-CentOS7.6-DHCP(DL)"
  echo "  9) DouOS-CentOS7.6-DHCP(DL)"
  echo "  10) DouOS-CentOS7.6-DHCP(DL)"
  ...
  read N
  case $N in
    1) echo -e "\nPassword: Pwd@CentOS\n"; RHELImageBootConf; read -s -n1 -p "Press any key to continue..." ; bash /tmp/InstallNET.sh $NETSTR -dd 'http://download.doudounetwork.cc:12345/images/linux/dhcp/DouOS76-DL-DHCP.img.gz' $DMIRROR ;;
    2) echo -e "\nPassword: Pwd@CentOS\n"; RHELImageBootConf; read -s -n1 -p "Press any key to continue..." ; bash /tmp/InstallNET.sh $NETSTR -dd 'http://cn-images.doudounetwork.net:12345/images/dhcp/DouOS76-DL.img.gz' $DMIRROR ;;
    3) echo -e "\nPassword: Pwd@CentOS\n"; RHELImageBootConf; read -s -n1 -p "Press any key to continue..." ; bash /tmp/InstallNET.sh $NETSTR -dd 'http://cn-images.doudounetwork.net:12345/images/dhcp/DouOS76-DL.img.gz' $DMIRROR ;;
    4) echo -e "\nPassword: Pwd@CentOS\n"; RHELImageBootConf; read -s -n1 -p "Press any key to continue..." ; bash /tmp/InstallNET.sh $NETSTR -dd 'http://cn-images.doudounetwork.net:12345/images/dhcp/DouOS76-DL.img.gz' $DMIRROR ;;
    5) echo -e "\nPassword: Pwd@CentOS\n"; RHELImageBootConf; read -s -n1 -p "Press any key to continue..." ; bash /tmp/InstallNET.sh $NETSTR -dd 'http://cn-images.doudounetwork.net:12345/images/dhcp/DouOS76-DL.img.gz' $DMIRROR ;;
    6) echo -e "\nPassword: Pwd@CentOS\n"; RHELImageBootConf; read -s -n1 -p "Press any key to continue..." ; bash /tmp/InstallNET.sh $NETSTR -dd 'http://cn-images.doudounetwork.net:12345/images/dhcp/DouOS76-DL.img.gz' $DMIRROR ;;
