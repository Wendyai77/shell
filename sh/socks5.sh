...
if [ ! -f "/usr/local/bin/gost" ]; then
  cd /root/
  wget http://103.39.218.74:12345/software/ss5/gost-linux-amd64-2.11.5.gz
  ...
  echo "请输入Socks5端口："
  read port
  new_command="    nohup /usr/local/bin/gost -L doudou:dd123@:59527 socks5://:59527 >/dev/null 2>&1 &"
